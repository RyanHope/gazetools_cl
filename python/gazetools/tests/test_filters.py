...
def test_savgol_coeffs():
    ...
    assert np.array_equal(smooth, np.array([-0.08391608,0.020979021,0.10256410,0.16083916,0.195804196,0.20745921,0.195804196,0.16083916,0.10256410,0.020979021,-0.08391608],dtype=np.float32))
